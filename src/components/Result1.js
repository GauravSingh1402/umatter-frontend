		...
		<div>
			...
			<div>
				<h2 className=" text-xl text-justify px-10 my-10 md:px-32 md:my-20">
					Our test analysis suggests that you{" "}
					<span className="font-bold text-red">
						could be at risk for depression
					</span>{" "}
					based on the responses we received. Consider engaging in some helpful
					activities, or if necessary, seek medical advice for assistance.
				</h2>
			</div>
